...
"""
Base tests for demonstrating CP with dependence on predictive uncertainty using a probablistic model (GP) und er covariate shift - 
Experimentally evaluating the math behind Equation 5 page 10 of on https://people.eecs.berkeley.edu/~angelopoulos/publications/downloads/gentle_intro_conformal_dfuq.pdf
"""
...
y_viz= func(x_viz)
y_mean, y_std = gpr.predict(x_viz, return_std=True)
prediction_sets =  [y_mean - y_std*qhat, y_mean + y_std*qhat]
